...
# -*- coding: utf-8 -*-
"""
Inference without custom loss - loads model with compile=False
Includes label_min adjustment to show actual people count
"""
...
# LABEL ADJUSTMENT
# =====================================================
# Training code does: labels = labels - label_min
# So if original labels are [1,2,3,4,5,6], model learns [0,1,2,3,4,5]
# We add label_min back to show actual people count
...
class RadarInference:
    def __init__(self, model_path, label_min=LABEL_MIN):
        ...
        print("✓ Model loaded successfully (inference-only mode)")
...
if __name__ == "__main__":
    MODEL_PATH = './people_count_tcn.h5'
    DATA_FILE = './processed_dataset/data_test.npy'
    LABELS_FILE = './processed_dataset/labels_test.npy'

    print("="*80)
    print("RADAR INFERENCE (NO LOSS REQUIRED)")
    print("="*80)

    inferencer = RadarInference(MODEL_PATH, label_min=LABEL_MIN)
